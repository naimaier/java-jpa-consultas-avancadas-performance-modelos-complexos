...
public class ProdutoDAO {
	...
	public List<Produto> buscaPorParametros(String nome, 
			BigDecimal preco, LocalDate dataCadastro){
		String jpql = "SELECT p FROM Produto p WHERE 1=1 ";
		//gambiarra para utilizar o where sem critérios
	...
	public List<Produto> buscaPorParametrosComCriteria(String nome, 
		...
		//query.select(); quando o select é o mesmo que o from não é preciso preencher o select.
